...
st.markdown("""
    ...
    /* 가로 버튼 정렬 강제 고정 (아이폰용) */
    .st-key-incen_buttons div[data-testid="stHorizontalBlock"] {
        display: flex !important;
        flex-direction: row !important;
        gap: 5px !important;
    }
    .st-key-incen_buttons div[data-testid="stHorizontalBlock"] > div {
        flex: 1 !important;
...
if not df_all.empty:
    ...
    if not p_df.empty:
        ...
        st.write(f"**💰 예상 수령액: {int(cfg['base_salary'] + total_extra - cfg['insurance']):,}원**")
