...
# 페이지 설정
st.set_page_config(page_title="아이폰 정산 시스템 v1.1.1", layout="centered")
...
st.markdown('<p class="version-text">v1.1.1-stable</p>', unsafe_allow_html=True)
...
# [수정된 부분] 아이폰에서 가로로 정렬되도록 nowrap 설정된 컬럼 사용
